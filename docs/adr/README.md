...
- [ADR-DOMAIN-002: Delivery D1.2 Schema Scope and Moderator Semantics](ADR-DOMAIN-002-d1-2-schema-scope-and-moderator-semantics.md) records the accepted Delivery D1.2 scope and Moderator semantics, preserves ADR-DOMAIN-001, and does not itself authorize Delivery D1.2 implementation.
- [ADR-DOMAIN-003: Delivery D1 Public Contract Vocabulary Reconciliation](ADR-DOMAIN-003-delivery-d1-public-contract-vocabulary-reconciliation.md) is Accepted; it records the accepted A2/B3/C2 vocabulary reconciliation, preserves ADR-DOMAIN-001 and ADR-DOMAIN-002, and does not authorize Delivery D1.2 implementation.
